      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-between items-center mb-8">
          <Link to="/" className="flex items-center space-x-2">
            <Logo />
            <span className="text-2xl font-bold">OneShop</span>
          </Link>
        ...
        <div className="flex justify-center space-x-8 mb-8">
          ...
          <Link to="/stock" className="text-white hover:text-gray-200">Stock</Link>
          <Link to="/sales" className="text-white hover:text-gray-200">Sales</Link>
          <Link to="/dashboard" className="text-white hover:text-gray-200">Dashboard</Link>
          <Link to="/support" className="text-white hover:text-gray-200">Support</Link>
        </div>

        {/* Copyright */}
        <div className="text-center text-sm border-t border-purple-500 pt-4">
          <p>&copy; {new Date().getFullYear()} OneShop. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
